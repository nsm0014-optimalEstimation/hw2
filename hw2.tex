...
\begin{questions}
    ...
    \begin{parts}
        ...
        \solution{
            To make sure my least squares process is correct, displayed below are figures of the noise (figure \ref{fig:1}), the true rotation (figure \ref{fig:2}) and the gyroscope measurement with the added scale factor and bias (figure \ref{fig:3}).

            \begin{figure}[!h]
                \label{fig:1}
                \centering
                \includegraphics[width=\linewidth]{Q3a_n.png}
            \end{figure}

            \begin{figure}[!h]
                \label{fig:2}
                \centering
                \includegraphics[width=\linewidth]{Q3a_r.png}
            \end{figure}

            \begin{figure}[!h]
                \label{fig:3}
                \centering
                \includegraphics[width=\linewidth]{Q3a_g.png}
            \end{figure}
        }
        \clearpage
